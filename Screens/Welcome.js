...
export default class WelcomeScreen extends React.Component {
    ...
    render() {
        return (
            <View style={styles.container} >
                {this.showModal()}
                <TextInput value={this.state.email} style={{ textShadowColor: "blue", shadowOffset: { width: 10, height: 20 }, shadowOpacity: 0.2 }} onChangeText={(text) => { this.setState({ email: text }) }} placeholder="Email" keyboardType="email-address">
                </TextInput>
                <TextInput value={this.state.password} style={{ textShadowColor: "blue", shadowOffset: { width: 10, height: 20 }, shadowOpacity: 0.2 }} onChangeText={(text) => { this.setState({ password: text }) }} placeholder="Password" keyboardType="visible-password">
                </TextInput>
